...
- LLMs are not AGI.
- there is **no** substitution for human understanding.
...
LLMs are to be used as extensions to existing technology but not as a replacement. The following are still necessary:
